...
namespace TESTER
{
    public class EXM6640A
    {
        ...
        private string MeasureEquip_IP;
        ...
        /*----------------------------------------------------------*/
        public EXM6640A(string _MeasureEquip_IP) {
            this.MeasureEquip_IP = _MeasureEquip_IP;
            try {
                ...
                throw new Exception("[E6640A_VISA]Không kết nối được với máy đo IP= " + MeasureEquip_IP);
        ...
        */
        ...
        public void ClearLog() {
            try {
                ...
                throw new Exception("Không xóa được logfile của E6640A");
        ...
        private static void saveLogfile(string pathfile, string content)// 
        {
            try {
                ...
                throw new Exception("Loi save logfile");
        ...
        public string HienThi() {
            ...
            try {
                ...
                result_Value1 = mbSession.Query(":FETC:EVM?");
                Thread.Sleep(100);
